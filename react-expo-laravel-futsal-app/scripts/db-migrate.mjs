...
try {
  await client.query(`
    ALTER TABLE "bookings"
      ...
      ADD COLUMN IF NOT EXISTS "cancellation_money_status" text NOT NULL DEFAULT 'none',
      ADD COLUMN IF NOT EXISTS "cancellation_received_amount" integer NOT NULL DEFAULT 0,
      ADD COLUMN IF NOT EXISTS "cancellation_refunded_amount" integer NOT NULL DEFAULT 0,
      ADD COLUMN IF NOT EXISTS "cancellation_money_resolved_at" timestamp,
      ADD COLUMN IF NOT EXISTS "cancellation_money_resolved_by" integer;
  ...
  `);
  console.log("[db-migrate] booking lifecycle and payment columns are ready");
} finally {
  await client.end();
}
