                ...
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="min-w-0 flex-1 p-4 sm:p-5">
                    ...
                    {gone(b.status) && (b.cancellationReceivedAmount ?? 0) > 0 && (
                      <div className="mt-3 rounded-2xl border border-violet-200 bg-violet-50 px-3.5 py-3 text-xs dark:border-violet-500/25 dark:bg-violet-500/10">
                        <p className="font-black text-violet-900 dark:text-violet-100">💰 Received before cancellation: {formatNPR(b.cancellationReceivedAmount ?? 0)}</p>
                        <p className="mt-0.5 font-bold leading-relaxed text-violet-800/80 dark:text-violet-200/80">{cancellationMoneyLabel(b.cancellationMoneyStatus)}</p>
                      </div>
                    )}
