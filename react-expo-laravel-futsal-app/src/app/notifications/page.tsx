...
export default function NotificationsPage() {
  ...
  // Notifications can arrive while this page is already open (for example,
  // when an owner accepts a booking in another tab). Refresh the visible inbox
  // from the database every few seconds without disturbing swipe/read state.
  useEffect(() => {
    if (!user) return;
