...
export function MobileNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 border-t border-[#F0E3CC] bg-white/95 shadow-[0_-8px_30px_rgba(180,120,60,0.10)] backdrop-blur-xl lg:hidden dark:border-white/10 dark:bg-slate-950/95">
      <div
          ...
          return (
            <Link
              ...
              className={`flex min-w-0 flex-col items-center gap-1 rounded-xl py-2.5 text-[10px] font-bold transition ${
                active ? "text-emerald-700 dark:text-emerald-400" : "text-stone-400 dark:text-slate-500"
              }`}
            >
              <span
