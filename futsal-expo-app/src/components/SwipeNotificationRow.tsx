    ...
    <View style={styles.swipeShell}>
      ...
      >
        <View style={styles.badgeColumn}>
          ...
          <View style={[styles.readStatus, { backgroundColor: n.isRead ? c.inset : colors.red500 }]}>
            <Text style={[styles.readStatusText, { color: n.isRead ? c.textMuted : "#FFFFFF" }]}>
        ...
        >
          <Text style={[styles.noteTitle, { color: c.text }]}>            {!n.isRead && owner ? <Text style={styles.unreadDot}>● </Text> : null}
            {n.title}
          </Text>
...
const styles = StyleSheet.create({
  ...
  readStatusText: { fontSize: 9, fontWeight: "900", textTransform: "uppercase", letterSpacing: 0.4 },
  badgeText: {
  ...
  unreadDot: { color: colors.red500, fontSize: 12 },
