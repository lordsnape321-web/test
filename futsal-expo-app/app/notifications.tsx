        ...
        renderItem={({ item: n }) => {
          ...
          return (
            ...
            >
              ...
              >
                <Text style={[styles.noteTitle, { color: c.text }]} numberOfLines={3}>{n.title}</Text>
                {n.message ? (
                  <Text style={[styles.noteMessage, { color: c.textMuted }]} numberOfLines={4}>{n.message}</Text>
                ) : null}
...
const styles = StyleSheet.create({
  ...
  badgeColumn: { width: 104, flexShrink: 0 },
  noteContent: { flex: 1, minWidth: 0 },
  noteActions: { width: 92, flexShrink: 0, alignItems: "stretch", gap: space[2] },
